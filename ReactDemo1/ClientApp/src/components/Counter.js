...
export class Counter extends Component {
    ...
    render() {
        return (
            ...
            In 1918, a vessel known as a dumping scow became disconnected from its tug boat ¡ª with two men aboard ¡ª during a dredging operation, according to the Commission, an agency of the Ontario Ministry of Tourism, Culture and Sport. The scow got stranded in the Niagara River, some 650 yards shy of Horseshoe Falls, one of three separate waterfalls that make up Niagara Falls.
                </p>
                <p>
